...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/component_trappedion.jpg" width="500" title="classical heat engines" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<!--- <div class="caption">
    A zoomed-in view of the sculpture's trapped-ion quantum engine.
</div> --->
