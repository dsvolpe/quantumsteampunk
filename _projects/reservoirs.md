...
As mentioned in [Classical Heat Engines](../classical.md), a heat engine converts
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/full_reservoirs.jpg" title="classical heat engines" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    A zoomed-in view of the sculpture's hot and cold reservoirs, which are hiding near the bottom of the sphere.
</div>
