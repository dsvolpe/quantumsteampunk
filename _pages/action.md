...
Next, the engine is disconnected from the hot reservoir. In other words, the electrodes quit spewing out a random electric field. The ion cools under the influence of a laser, which serves as a cold reservoir. 1 The ion’s wave function contracts back into the funnel’s tip, similarly to a gas undergoing compression. If you measured the ion’s position after the contraction, you’d have a high probability of finding the ion in the funnel tip. The ion has returned to its initial conditions: localized in the funnel tip, at a low temperature. The next cycle begins by heating the ion back up.

[Filigree border in same color but different style]
