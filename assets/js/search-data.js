...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/quantumsteampunk/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/quantumsteampunk/blog/";
          },
        },{id: "nav-publications",
          title: "publications",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/quantumsteampunk/repositories/";
          },
        },{id: "nav-cv",
          title: "cv",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/quantumsteampunk/cv/";
          },
        },{id: "nav-teaching",
          title: "teaching",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/quantumsteampunk/teaching/";
          },
        },{id: "nav-people",
          title: "people",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/quantumsteampunk/people/";
          },
